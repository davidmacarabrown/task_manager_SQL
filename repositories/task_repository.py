...
def save(task):
    # pdb.set_trace()
    sql = "INSERT INTO tasks (description, duration, completed, user_id) VALUES (%s, %s, %s, %s) RETURNING *" 
    values = [task.description, task.duration, task.completed, task.user.id]
